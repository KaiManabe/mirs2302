...
if ($_SERVER['REQUEST_METHOD'] === 'GET'){
    ...
    $command = "python3 $pythonScriptPath mode=RECEIVE $type$receivedData"; // なぜかescapeshellarg()を使用すると2byte文字が消えてしまう
