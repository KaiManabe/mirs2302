...
function onLoad(){
    ...
    */
    ...
    //var ans = readFormData('yes','no','receive_time', 'receive_place');
    //var yes = ans.slice(0,1);

    document.querySelector('#text').textContent = `${mail}さんから${thing}を${limit_time}まで${ans}に集荷するように依頼が来ています`; //テキスト差し替え
